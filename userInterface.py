...
import tkinter.font
from tkinter import *
from pages import cashFlowPage,homePage,incomeStatementPage
...
class UserInterFace(tk.Tk):
    def __init__(self):
        ...
        for F in (homePage.Startpage, cashFlowPage.cashflow, plotDebtGraph, incomeStatementPage.IncomeStatement, plotRevenueChart, plotCashToEarnings):
